...
static const u1_t PROGMEM APPEUI[8]={ 0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
static const u1_t PROGMEM APPKEY[16] = { 0x07, 0x77, 0x26, 0xE3, 0xB5, 0x80, 0x41, 0x1B, 0x35, 0xC5, 0xF6, 0x31, 0x93, 0xBC, 0x40, 0xFB };
...
// Aquí se escriben las variables que se
// van a utilizar para la lectura de datos
// del sensor que se utilice
...
// Mapeo de pines del módulo LoRa
...
// Función que detecta el caso a ejecutar dependiendo de
// lo que envíe el módulo LoRa. No modificar esta función
...
void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
        ...
        // Aquí va el código de lectura del sensor
        // así como los cálculos necesarios para
        // obtener el valor final. El valor final
        //  que se quiere enviar al agteway se
        // reemplaza por FILMEIN
...
void setup() {
    ...
    // Reemplazar PIN_A_UTILIZAR
    // con el pin que se usa para
